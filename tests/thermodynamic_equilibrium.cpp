...
constexpr double       domain_size = 1e-2;

constexpr double ND = 1e22;
constexpr double NA = 1e23;


class ThermodynamicEquilibriumTest : public Ddhdg::NPSolver<dim>,
                                     public ::testing::Test
{
public:
...
TEST_F(ThermodynamicEquilibriumTest,
       compute_thermodynamic_equilibrium) // NOLINT
{
  ...
  this->compute_thermodynamic_equilibrium();
}
