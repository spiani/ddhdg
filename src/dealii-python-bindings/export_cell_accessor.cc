...
#ifdef USE_PYBIND11
  void
  export_cell_accessor(pybind11::module &m)
  {
    pybind11::class_<CellAccessorWrapper>(m, "CellAccessor")
      .def(pybind11::init<TriangulationWrapper &, const int, const int>())
      .def_property("refine_flag",
                    &CellAccessorWrapper::get_refine_flag,
                    &CellAccessorWrapper::set_refine_flag,
                    refine_flag_docstring)
      .def_property("coarsen_flag",
                    &CellAccessorWrapper::get_coarsen_flag,
                    &CellAccessorWrapper::set_coarsen_flag,
                    coarsen_flag_docstring)
      ...
      .def("center",
           &CellAccessorWrapper::get_center,
           center_docstring,
           pybind11::arg("respect_manifold")             = false,
