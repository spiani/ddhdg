...
#ifdef USE_PYBIND11
  void
  export_tria_accessor(pybind11::module &m)
  {
    pybind11::class_<TriaAccessorWrapper>(m, "TriaAccessor")
      .def(pybind11::init<void *, const int, const int, const int>())
      .def_property("boundary_id",
                    &TriaAccessorWrapper::get_boundary_id,
                    &TriaAccessorWrapper::set_boundary_id,
                    boundary_id_docstring)
      .def_property("manifold_id",
                    &TriaAccessorWrapper::get_manifold_id,
                    &TriaAccessorWrapper::set_manifold_id,
                    manifold_id_docstring)
      .def("barycenter",
      ...
      .def("center",
           &TriaAccessorWrapper::get_center,
           center_docstring,
           pybind11::arg("respect_mainfold")             = false,
           pybind11::arg("interpolate_from_surrounding") = false)
      .def("set_vertex",
           &TriaAccessorWrapper::set_vertex,
           set_vertex_docstring,
           pybind11::arg("i"),
           pybind11::arg("point_wrapper"))
      .def("get_vertex",
           &TriaAccessorWrapper::get_vertex,
           get_vertex_docstring,
           pybind11::arg("i"))
      ...
      .def("set_all_boundary_ids",
           &TriaAccessorWrapper::set_all_boundary_ids,
           set_all_boundary_ids_docstring,
           pybind11::arg("boundary_id"))
      .def("measure", &TriaAccessorWrapper::measure, measure_docstring);
  }
#endif
} // namespace python
