...
namespace python
{
  ...
  public:
     ...
     */
    void
    generate_simplex(PYSPACE::list &vertices);
     ...
     */
    void
    generate_cheese(PYSPACE::list &holes);

    /*! @copydoc GridGenerator::general_cell
     */
    void
    generate_general_cell(PYSPACE::list &vertices, const bool colorize = false);

    /*! @copydoc GridGenerator::parallelogram
     */
    void
    generate_parallelogram(PYSPACE::list &corners, const bool colorize = false);

    /*! @copydoc GridGenerator::parallelepiped
     */
    void
    generate_parallelepiped(PYSPACE::list &corners,
                            const bool     colorize = false);
     ...
     */
    void
    generate_varying_subdivided_parallelepiped(PYSPACE::list &n_subdivisions,
                                               PYSPACE::list &corners,
                                               const bool     colorize = false);
     ...
     */
    void
    transform(PYSPACE::object &transformation);
